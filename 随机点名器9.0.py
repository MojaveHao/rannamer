...
print("--------Debug Info--------")
print("mdoe:",mode)
print("nameshuliang:",nameshuliang)
print("namelist:",namelist)
print("diyname:",diyname)
print("ls:",ls)
print("raname v9.0")
print("--------Debug Info--------")
def read_con(cfilename):
      if cfilename == 'con_mode':
            with open('con_mode.txt','w',encoding='utf-8') as f:
                  ls = f.readlines()
                  f.close
      if cfilename == 'con_sl':
            with open('con_sl.txt','w',encoding='utf-8') as f:
                  ls = f.readlines()
                  f.close
def write_con(cfilename,mode):
      if cfilename == 'con_mode':
            with open('con_mode.txt','r',encoding='utf-8') as f:
                  ls = f.readlines()
                  f.close
      if cfilename == 'con_sl':
            with open('con_sl.txt','r',encoding='utf-8') as f:
                  ls = f.readlines()
                  f.close
while True:
      if mode == 1:
